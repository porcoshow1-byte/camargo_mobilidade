                    ...
                    >
                        {banner.imageUrl ? (
                            ...
                            <div className="w-full h-full bg-gradient-to-r from-orange-500 to-orange-600 flex flex-col items-center justify-center text-white p-4">
                                ...
                                {banner.showCta !== false && (
                                    <button className="mt-2 px-4 py-1.5 bg-white text-orange-600 rounded-full text-xs font-bold shadow-sm pointer-events-auto hover:bg-orange-50 transition-colors">
                                        Saiba mais
                                    </button>
                                )}
                            </div>
                        ...
                        {banner.imageUrl && banner.showCta && isVisible && (
                            <div className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none">
                                <button className="bg-white text-orange-600 px-6 py-2 rounded-full text-sm font-bold shadow-lg uppercase tracking-wide transform hover:scale-105 transition-transform pointer-events-auto cursor-pointer border-2 border-white/50">
